...
public class SectionFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        CardView b1 = (CardView) view.findViewById(R.id.bu1);
        CardView b2 = (CardView) view.findViewById(R.id.bu2);
        CardView b3 = (CardView) view.findViewById(R.id.bu3);
        CardView b4 = (CardView) view.findViewById(R.id.bu4);
